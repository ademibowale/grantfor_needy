...
const guest = [
  {
    ...
    name: 'AGENT BRENT THOMSON LEONARD',
...
function onVideoPlay() {
  ...
  myVideo.play(); // You could also pause the video, add event listeners, etc.
}
